...
public class ExampleInfo {
	/**
	 *  Property of byte format. An byte between -128 and 127.
	 */
	public byte byteProp = 0;
	/**
	 *  Property of short format. A 16-bit signed integer between -32768 and 32767.
	 */
	public short shortProp = 0;
	/**
	 ...
	 *  Byte list property.
	 */
	public List<Byte> byteListProp = new ArrayList<Byte>();
	/**
	 *  Short list property.
	 */
	public List<Short> shortListProp = new ArrayList<Short>();
	/**
	 *  Int list property.
	 */
	 ...
	 *  Float list property.
	 */
	public List<Float> floatListProp = new ArrayList<Float>();
	/**
	...
	public static final ExampleInfo fromBytes(byte[] bytes) {
		...
		if (3 < atts.size())
			info.floatProp = BuffConverter.getInstance().floatFromBuff("floatProp", atts.get(3));
		if (4 < atts.size())
			info.doubleProp = BuffConverter.getInstance().doubleFromBuff("doubleProp", atts.get(4));
		if (5 < atts.size())
			info.boolProp = BuffConverter.getInstance().boolFromBuff("boolProp", atts.get(5));
		if (6 < atts.size())
			info.stringProp = BuffConverter.getInstance().stringFromBuff("stringProp", atts.get(6));
		if (7 < atts.size())
			info.longstringProp = BuffConverter.getInstance().longstringFromBuff("longstringProp", atts.get(7));
		if (8 < atts.size())
			info.bytesProp = BuffConverter.getInstance().bytesFromBuff("bytesProp", atts.get(8));
		if (9 < atts.size())
			info.att1Prop = BuffConverter.getInstance().attInfoFromBuff("att1Prop", atts.get(9));
		if (10 < atts.size())
			info.att2Prop = BuffConverter.getInstance().attInfoFromBuff("att2Prop", atts.get(10));
		if (11 < atts.size())
			info.byteListProp = BuffListConverter.getInstance().byteListFromBuff("byteListProp", atts.get(11));
		if (12 < atts.size())
			info.shortListProp = BuffListConverter.getInstance().shortListFromBuff("shortListProp", atts.get(12));
		if (13 < atts.size())
			info.intListProp = BuffListConverter.getInstance().intListFromBuff("intListProp", atts.get(13));
		if (14 < atts.size())
			info.floatListProp = BuffListConverter.getInstance().floatListFromBuff("floatListProp", atts.get(14));
		if (15 < atts.size())
			info.doubleListProp = BuffListConverter.getInstance().doubleListFromBuff("doubleListProp", atts.get(15));
		if (16 < atts.size())
			info.boolListProp = BuffListConverter.getInstance().boolListFromBuff("boolListProp", atts.get(16));
		if (17 < atts.size())
			info.stringListProp = BuffListConverter.getInstance().stringListFromBuff("stringListProp", atts.get(17));
		if (18 < atts.size())
			info.longstringListProp = BuffListConverter.getInstance().longstringListFromBuff("longstringListProp", atts.get(18));
		if (19 < atts.size())
			info.bytesListProp = BuffListConverter.getInstance().bytesListFromBuff("bytesListProp", atts.get(19));
		if (20 < atts.size())
			info.attInfo1ListProp = BuffListConverter.getInstance().attInfoListFromBuff("attInfo1ListProp", atts.get(20));
		if (21 < atts.size())
			info.attInfo2ListProp = BuffListConverter.getInstance().attInfoListFromBuff("attInfo2ListProp", atts.get(21));
		return info;
	}
